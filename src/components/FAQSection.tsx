    ...
    >
      <div className="max-w-4xl mx-auto px-8">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-2xl mb-3 text-amber-900">What is Diversion 2026?</h3>
          ...
          <div>
            <h3 className="text-2xl mb-3 text-amber-900">Who can participate?</h3>
            <p className="text-amber-800">
          ...
          <div>
            <h3 className="text-2xl mb-3 text-amber-900">Do I need a team?</h3>
            <p className="text-amber-800">
          ...
          <div>
            <h3 className="text-2xl mb-3 text-amber-900">What should I bring?</h3>
            <p className="text-amber-800">
          ...
          <div>
            <h3 className="text-2xl mb-3 text-amber-900">Are there prizes?</h3>
            <p className="text-amber-800">
          ...
          <div>
            <h3 className="text-2xl mb-3 text-amber-900">Is accommodation provided?</h3>
            <p className="text-amber-800">
